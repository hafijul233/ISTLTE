...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 11, 2018 at 11:10 PM
...
DROP TABLE IF EXISTS `studenteducationinfo`;
...
DROP TABLE IF EXISTS `studentparentsinfo`;
...
DROP TABLE IF EXISTS `studentprofileinfo`;
...
DROP TABLE IF EXISTS `userauthenticationinfo`;
