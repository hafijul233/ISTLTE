<header class="main-header">
    <a href="index.php?page=Dashboard" class="logo">
        <span class="logo-mini"><?php echo "IST"; ?></span>
      <span class="logo-lg"><?php echo $programTitle; ?></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php echo "Hafijul Islam"; ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  <?php echo "Hafijul Islam" . " - " . strtoupper($_SESSION["UserCategory"]); ?>
